...
namespace Mapdigit.Drawing.Geometry
{
    ...
    internal abstract class Curve
    {
                                                ...
                                                double px, double py)
        {
            ...
            if (pi.CurrentSegment(coords) != PathIterator.SegMoveto)
            {
         ...
         */
        public const int RectIntersects = 0x8000000;
                                               ...
                                               double rxmax, double rymax)
        {
            ...
            int crossings = 0;
            while (crossings != RectIntersects && !pi.IsDone())
            {
                double endx;
                double endy;
                switch (pi.CurrentSegment(coords))
                                               ...
                                               int level)
        {
            ...
            if (x0 >= rxmax && xc >= rxmax && x1 >= rxmax)
            {
                ...
                // rem that we may have 0, 1, or 2 crossings as the control
